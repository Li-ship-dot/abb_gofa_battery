...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Controller manager service name (e.g. 'controller_manager' or 'moveit_/controller_manager')",
        )
    )
    sim_arg = LaunchConfiguration("sim")
    controller_manager_name_arg = LaunchConfiguration("controller_manager_name")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("abb_gofa_crb15000_10_152_moveit_config"), "launch"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("abb_gofa_crb15000_10_152_moveit_config"),
        "config",
